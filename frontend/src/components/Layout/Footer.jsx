function Footer() {
  return (
    <footer>
      <div className="wow fadeInUp bg-primary py-7 dark:bg-black h-[59px] ">
          ...
          <div className="-mx-3 flex flex-wrap">
            ...
            <div className="w-full px-3 md:w-1/2 lg:w-1/3">
              <div className="flex items-center justify-center space-x-4 sm:space-x-8 md:justify-end lg:justify-end">
                <a className="text-base text-white">Privacy Policy</a>
                <a className="text-base text-white">Terms and conditions</a>
              </div>
            </div>
          </div>
        </div>
