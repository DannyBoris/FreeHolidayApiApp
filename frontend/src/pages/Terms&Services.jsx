...
function TermsServices() {
        ...
        <div data-custom-className="body">
          <div style="text-align: left; ">
            ...
            >
              ...
              <bdt className="question">
                <strong>August 08, 2024</strong>
              </bdt>
            </div>
            <div className="MsoNormal" style="line-height: 1.1;">
              <br />
            </div>
            <div className="MsoNormal" style="line-height: 115%;">
              <br />
            </div>
            <div className="MsoNormal" style="line-height: 115%;">
              <br />
          ...
          <div style="text-align: left;">
            <div className="MsoNormal" id="agreement" style="line-height: 1.5;">
  ...
  mso-themetint:166;"
                    ...
                    <bdt className="question">311767685.</bdt>
                    <bdt className="statement-end-if-in-editor"></bdt>
                  </span>
                </span>
              </span>
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
              >
                ...
                <span style="color: rgb(0, 58, 250);">
                  <bdt className="question">
                    holiday-api-test-front.onrender.com
                  </bdt>
                </span>{" "}
                ...
                <bdt className="statement-end-if-in-editor"></bdt>)
                <bdt className="block-component"></bdt>
                <bdt className="block-component"></bdt>, as well as any other
                related products and services that refer or link to these legal
                terms (the <bdt className="block-component"></bdt>"
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
              >
                ...
                <bdt className="block-component">
                  email at{" "}
                  <bdt className="question">dannyboris1993@gmail.com</bdt>
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
              >
                ...
                <bdt className="question">Danny Borisov</bdt>, concerning your
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
              >
                ...
                Terms <bdt className="block-component"></bdt>from time to time
                <bdt className="else-block"></bdt>. We will alert you about any
                changes by updating the <bdt className="block-component"></bdt>
                "Last updated"
                <bdt className="statement-end-if-in-editor"></bdt> date of these
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
            ...
            <div className="MsoNormal" style="line-height: 1.5;">
              <a data-custom-className="link" href="#socialmedia">
                <span style="color: rgb(0, 58, 250); font-size: 15px;">
                  <span data-custom-className="body_text">
                    <bdt className="block-component"></bdt>10. SOCIAL MEDIA
                    <bdt className="statement-end-if-in-editor"></bdt>
                  </span>
                </span>
              </a>{" "}
            ...
            <div className="MsoNormal" style="line-height: 1.5;">
              <a data-custom-className="link" href="#advertisers">
                <span style="color: rgb(0, 58, 250); font-size: 15px;">
                  <span data-custom-className="body_text">
                    <bdt className="block-component"></bdt>11. ADVERTISERS
                    <bdt className="statement-end-if-in-editor"></bdt>
                  </span>
                </span>
              </a>{" "}
            ...
            <div className="MsoNormal" style="line-height: 1.5;">
              <a data-custom-className="link" href="#ppno">
                <span style="color: rgb(0, 58, 250); font-size: 15px;">
                  <span data-custom-className="body_text">
                    <bdt className="block-component"></bdt>13. PRIVACY POLICY
                    <bdt className="statement-end-if-in-editor"></bdt>
                  </span>
                </span>
              </a>{" "}
            ...
            <div className="MsoNormal" style="line-height: 1.5;">
              <a data-custom-className="link" href="#corrections">
                <span style="color: rgb(0, 58, 250); font-size: 15px;">
                  <span data-custom-className="body_text">18. CORRECTIONS</span>
                </span>
              </a>{" "}
            ...
            <div className="MsoNormal" style="line-height: 1.5;">
              <a data-custom-className="link" href="#disclaimer">
                <span style="color: rgb(0, 58, 250); font-size: 15px;">
                  <span data-custom-className="body_text">19. DISCLAIMER</span>
                </span>
              </a>{" "}
            ...
            <div className="MsoNormal" style="line-height: 1.5;">
              <a data-custom-className="link" href="#california">
                <span style="color: rgb(0, 58, 250); font-size: 15px;">
                  <span data-custom-className="body_text">
                    <bdt className="block-component"></bdt>24. CALIFORNIA USERS
                    AND RESIDENTS
                    <bdt className="statement-end-if-in-editor"></bdt>
                  </span>
                </span>
            ...
            <div className="MsoNormal" style="line-height: 1.5;">
              <a data-custom-className="link" href="#contact">
                <span style="color: rgb(0, 58, 250); font-size: 15px;">
                  <span data-custom-className="body_text">26. CONTACT US</span>
                </span>
              </a>
            </div>
          </div>
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
              >
                ...
                <bdt className="question">dannyboris1993@gmail.com</bdt>. If we
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
              >
                <strong>
                  Your submissions<bdt className="block-component"></bdt>
                </strong>
              </span>
            </div>
            <div className="MsoNormal" style="line-height: 1.5;">
            ...
            >
              <span style="font-size: 15px;">
                ...
                or compensation to you.<bdt className="block-component"></bdt>
              </span>
            </div>
            <div className="MsoNormal" style="line-height: 1.5;">
              <br />
            ...
            >
              <span style="font-size: 15px;">
                ...
                <bdt className="block-component"></bdt> you:
              </span>
            </div>
            <ul>
              <li
              ...
              >
                ...
                <span style="font-size: 15px;">
                  ...
                  Services any Submission<bdt className="block-component"></bdt>{" "}
              ...
              >
                <span style="font-size: 15px;">
                  ...
                  <bdt className="block-component"></bdt> are original to you or
                  ...
                  such Submissions<bdt className="block-component"></bdt> and
              ...
              >
                <span style="font-size: 15px;">
                  ...
                  <bdt className="block-component"></bdt> do not constitute
            ...
            >
              ...
              <bdt className="block-component"></bdt> and you expressly agree to
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
            ...
            >
              <strong>
                <span style="font-size: 19px;">6. SUBSCRIPTIONS</span>
              </strong>
            </div>
            <div className="MsoNormal" style="line-height: 1.5;">
              <bdt className="block-component"></bdt>
            ...
            >
              <strong>
                <span style="font-size: 15px;">Billing and Renewal</span>
              </strong>
            </div>
            <div className="MsoNormal" style="line-height: 1.5;">
              <span style="font-size: 15px;">
            ...
            >
              <span style="font-size: 15px;">
                <bdt className="block-component"></bdt>
                <bdt className="question">Purchase the service again</bdt>
                <bdt className="statement-end-if-in-editor"></bdt>
              </span>
            </div>
            <div className="MsoNormal" style="line-height: 1.5;">
            ...
            >
              <strong>
                <span style="font-size: 15px;">Fee Changes</span>
              </strong>
            </div>
            <div className="MsoNormal" style="line-height: 1.5;">
              <span style="font-size: 15px;">
            ...
            >
              ...
              >
                <span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">
                  ...
                  <bdt className="block-component"></bdt>endeavors
                  <bdt className="statement-end-if-in-editor"></bdt> except
                            ...
                            >
                              <bdt data-type="conditional-block">
                                ...
                                <span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">
                                  ...
                                  post content.
                                  <bdt className="block-component"></bdt> We may
                                  ...
                                  websites.
                                  <bdt className="block-component"></bdt> When
                    ...
                    <span style="color: rgb(89, 89, 89);">
                      <span style="font-size: 14px;">
                        <span data-custom-className="body_text">
                          ...
                          <bdt className="block-component"></bdt>libelous
                          <bdt className="statement-end-if-in-editor"></bdt>,
            ...
            >
              <span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">
                <span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">
                  ...
                  <bdt className="block-component"></bdt> and your choices
                  (including settings).
                </span>
              </span>
            </div>
                  ...
                  <bdt data-type="body">
                    ...
                    >
                      <span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">
                        ...
                        <bdt className="block-component"></bdt>"Third-Party
                        Account"
                        <bdt className="statement-end-if-in-editor"></bdt>) by
                        ...
                        <span style="font-size: 14.6667px;">Third-Party</span>{" "}
                        Account (the <bdt className="block-component"></bdt>
                        "Social Network Content"
                        <bdt className="statement-end-if-in-editor"></bdt>) so
            ...
            >
              <span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">
                ...
                <span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">
                  <bdt className="block-component"></bdt>the{" "}
                  <bdt className="question">United States</bdt>
                  <bdt className="block-component"></bdt>
                </span>
                <bdt className="block-component"></bdt>. If you access the
                ...
                <bdt className="block-component"></bdt>, then through your
                ...
                <bdt className="block-component"></bdt>, and you expressly
            ...
            >
              <span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);">
                ...
                . <bdt className="question">Danny Borisov</bdt> and yourself
            ...
            >
              <span style="font-size: 15px;">
                ...
                <bdt className="block-component"></bdt>
                <bdt className="question">Israel</bdt>
                <bdt className="statement-end-if-in-editor"></bdt> courts.{" "}
                <bdt className="question">Danny Borisov</bdt> shall also
                ...
                these Legal Terms are entered into in the course of your trade
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
              >
                ...
                SERVICES, (3) ANY <bdt className="block-component"></bdt>
                UNAUTHORIZED
                ...
                SHOULD USE YOUR BEST <bdt className="block-component"></bdt>
                JUDGMENT
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
              >
                ...
                >
                  ...
                  Services; (<span style="font-size: 14.6667px;">2</span>)
                  breach of these Legal Terms; (
                  <span style="font-size: 14.6667px;">3</span>) any breach of
                  your representations and warranties set forth in these Legal
                  Terms; (<span style="font-size: 14.6667px;">4</span>) your
                  violation of the rights of a third party, including but not
                  limited to intellectual property rights; or (
                  <span style="font-size: 14.6667px;">5</span>) any overt
                  ...
                  <bdt className="block-component"></bdt>defense
                  <bdt className="statement-end-if-in-editor"></bdt> and control
                  of any matter for which you are required to indemnify us, and
                  you agree to cooperate, at your expense, with our{" "}
                  <bdt className="block-component"></bdt>defense
                  <bdt className="statement-end-if-in-editor"></bdt> of such
  ...
  Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
              >
                ...
                <bdt className="block-component"></bdt>defenses
